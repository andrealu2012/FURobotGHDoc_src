...
if ($fileContent.Count -ge 2) {
    # 更新第二行的内容为您想要的字符串
    $fileContent[1] = "site_url: `"https://andrealu2012.github.io/FURobotDoc/`""
...
# 设置本地项目路径和远程仓库链接
$localRepoPath = "D:\Code\OpenSource\FURobotDoc\FURobotDoc"
$remoteRepoURL = "https://github.com/andrealu2012/FURobotDoc.git"  # 替换为你的远程仓库链接
